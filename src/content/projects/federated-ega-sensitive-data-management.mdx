...
project_number:
    ...
    link: https://drive.google.com/file/d/1lu5J6til3qWFytYp3GbcnjRUqrb3-U7Y/view?usp=sharing
period: 2022-01 2023-12
external_link: https://elixir-europe.org/communities/human-data
keywords: ["FAIR", "training", "human", "compute", "tool"]
---
The Deliverables from this project will be incorporated by the FEGA governance framework
...
human data.
ELIXIR Norway is one of five vanguard nodes and is contributing by capacity building of the national FEGA node and to position the Federated EGA (FEGA) framwork as the core infrastructure driver to support human data sharing for research use-cases from nationally, European Commission, and/or internationally funded human health data sharing projects.
