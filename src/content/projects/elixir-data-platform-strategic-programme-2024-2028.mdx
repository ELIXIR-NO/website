...
The porject is organised into five Work Packages:
...
ELIXIR Norway is participating in WP2 helping in connecting ELIXIR data resources with data contributors in the various ELIXIR nodes in adddition to establising best practices and training paths in the field.
