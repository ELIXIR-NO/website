...
For this hackathon we are encouraging you to apply with a RDM tool project. We are looking for more long term projects that will be maintained after the hackathon and not limited to short time research projects. 

## Funding:
We will support your participation if your project is  selected through an application process evaluated by our selection committee. Funding will be available for up to 3 invited members per team for 4-5 teams and maximum support is 7000NOK per person.
