...
The Norwegian contribution is led by Professor Eivind Hovig from the ELIXIR Oslo node in collaboration with Kjell Petersen from the ELIXIR Bergen node and the Norwegian Directorate of Health.
